                ...
                {projects.map(project => (
                    <motion.div
                        ...
                        <div className="flex justify-between items-center mt-5 px-3">
                            ...
                            {project.id === 1 && (
                                <Link href={project.link} target="_blank" className={`flex gap-2 items-center px-4 py-2 ${booleanValue ? "bg-[#ececec] text-black" : "bg-[#1b1b1b]"} text-[16px] rounded-2xl hover:gap-3 duration-200`}>
                                    Demo
                                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" style={booleanValue ? { fill: '#000000' } : { fill: '#ffffff' }}>
